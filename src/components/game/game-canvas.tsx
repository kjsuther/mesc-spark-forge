        ...
        className={
          overlayFs
            ...
            : presentation
              ...
              : "relative mx-auto w-full max-w-full overflow-hidden rounded-lg bg-mn-blue ring-2 ring-mn-blue/60 shadow-lg [aspect-ratio:16/9] max-h-[calc(100svh-7rem)] [width:auto] [height:auto]"
        }
