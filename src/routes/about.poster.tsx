    ...
    <main id="main-content" className="max-w-5xl w-full mx-auto py-12 px-6 flex-1 space-y-16">
      ...
      <section id="real-world" className="scroll-mt-36">
        ...
        <p className="text-dark-gray/80 max-w-3xl leading-relaxed mb-6">
          ...
          takes an afternoon, and it's a cheap, honest rehearsal for changing the same thing in the
          actual system. When a player says "this part is unfair," they're usually telling us
        ...
        <p className="text-dark-gray/80 max-w-3xl leading-relaxed mt-6">
          This is how a game becomes more than a game. Playing it surfaces the friction faster than
          a requirements workshop. Fixing it live proves a concept is buildable before anyone writes
          a procurement document. And because every change traces back to a named person's feedback,
          the people closest to the problem stay visible in the solution — which is exactly the
          habit we want carried into the tools that real Medicaid clients depend on.
        </p>
      </section>
      ...
      <section
        id="ai"
        className="bg-sky-blue/10 border border-sky-blue/30 rounded-3xl p-8 scroll-mt-36"
      >
      ...
      <section
        id="path-forward"
        className="bg-mn-blue text-white rounded-3xl p-8 md:p-12 scroll-mt-36"
      >
